...
type CategoryType = 'technical' | 'worker' | 'report' | 'general' | 'feedback';
...
const ContactSupport = () => {
  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      icon: 'people-outline',
      description: 'Issues with worker accounts or assignments',
    },
    {
      id: 'report',
      label: 'Report Issue',
      icon: 'document-text-outline',
      description: 'Problems with report handling',
    },
    {
      id: 'general',
      label: 'General Inquiry',
      icon: 'help-circle-outline',
      description: 'Questions about the admin portal',
    },
    {
      id: 'feedback',
      label: 'Feedback',
        ...
        >
          ...
          <View style={styles.contactInfo}>
            <View style={styles.contactRow}>
              ...
              <Text style={styles.contactText}>{userData?.name || 'Admin'}</Text>
            </View>
            <View style={styles.contactRow}>
            ...
            <View style={styles.contactRow}>
              ...
              <Text style={[styles.contactText, { color: '#8B5CF6' }]}>Administrator Account</Text>
            </View>
          </View>
          ...
          <View style={styles.emergencyCard}>
            ...
            <View style={styles.emergencyContent}>
              ...
              <Text style={styles.emergencyText}>
                For critical technical issues affecting operations, please contact us at support@swachhsathi.com or call +91-XXXX-XXXXXX
              </Text>
            </View>
          </View>
        </ScrollView>
